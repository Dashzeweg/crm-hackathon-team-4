...
const KPI_RECURRING_REVENUE_MNT = 57_000_000;

const chartData = [
  { name: "Дав", promoted: 45, baseline: 30 },
  { name: "Мяг", promoted: 50, baseline: 35 },
  { name: "Лха", promoted: 65, baseline: 40 },
  { name: "Пүр", promoted: 80, baseline: 45 },
  { name: "Баа", promoted: 70, baseline: 35 },
  { name: "Бям", promoted: 95, baseline: 50 },
  { name: "Ням", promoted: 85, baseline: 55 },
];
    ...
    <div className="flex flex-col h-full animate-in fade-in zoom-in-95 duration-500 overflow-y-auto pb-12 custom-scrollbar">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
        ...
        <div className="bg-surface-container-lowest rounded-3xl p-8 shadow-xl border border-outline-variant/30 relative overflow-hidden group border-b-[6px]">
          ...
          <div className="flex items-baseline gap-4">
            <span className="text-5xl font-black text-on-surface tracking-tighter">
              {formatMntSay(KPI_RECURRING_REVENUE_MNT)}
            </span>
        ...
        <div className="bg-inverse-surface rounded-3xl p-8 shadow-2xl relative overflow-hidden text-white group border-b-[6px] border-black">
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-6">
              <span className="text-[10px] font-black text-outline-variant uppercase tracking-[0.2em]">
                Компанит ажлын ROI
              </span>
        ...
        <div className="flex justify-between items-center mb-10">
          <div>
            <h3 className="text-2xl font-black text-on-surface tracking-tight">
              Сурталчилгаатай ба энгийн өдрийн харьцуулалт
            </h3>
            <p className="text-sm font-bold text-on-surface-variant/50">
              Компанит ажил явуулсан өдөр болон энгийн өдрийн гүйцэтгэлийн
              харьцуулалт.
            </p>
          </div>
          <div className="flex gap-6">
            <div className="flex items-center gap-3 font-black text-[10px] text-on-surface-variant uppercase tracking-widest">
              <div className="w-3 h-3 rounded bg-primary-container shadow-sm"></div>{" "}
              Сурталчилгаа
            </div>
            <div className="flex items-center gap-3 font-black text-[10px] text-on-surface-variant uppercase tracking-widest">
              <div className="w-3 h-3 rounded bg-surface-dim shadow-sm"></div>{" "}
              Энгийн өдөр
            </div>
          </div>
        </div>
      ...
      <div className="bg-surface-container-lowest rounded-[2rem] shadow-xl border border-outline-variant/30 overflow-hidden border-b-[6px]">
        <div className="p-8 border-b border-outline-variant/20 flex justify-between items-center bg-surface-container-low">
          <h3 className="text-2xl font-black text-on-surface tracking-tight">
            Идэвхтэй компанит ажлын гүйцэтгэл
          </h3>
          <div className="flex gap-4">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-surface/50 border-b border-outline-variant/20">
                ...
                <th className="py-5 px-8 text-[10px] font-black text-outline uppercase tracking-[0.2em] text-right">
                  Нээх хувь
                </th>
                <th className="py-5 px-8 text-[10px] font-black text-outline uppercase tracking-[0.2em] text-right">
                  CTR
            ...
            <tbody className="text-sm font-bold text-on-surface">
              {[
                {
                  name: "Эргүүлэн татах: Алдагдах эрсдэл 3-р улирал",
                  icon: Mail,
                  type: "mail",
                  status: "Идэвхтэй",
                  open: "42.8%",
                ...
                {
                  name: "Худалдан авалтын дараах санал асуулга",
                  icon: Mail,
                  type: "mail",
                  status: "Идэвхтэй",
                  open: "51.0%",
                ...
                <tr
                  key={idx}
                  className="border-b border-outline-variant/10 hover:bg-surface-container-low transition-all h-[72px]"
                >
                  ...
                  <td className="py-4 px-8 text-right font-black">
                    {row.open}
                  </td>
