...
/* ---------------- Segment List Page ---------------- */
const SegmentListPage = ({ onOpenFilter, onOpenMethodPicker }) => (
  <>
    <div className="page-head">
      <div>
      ...
      <table className="table">
        <thead>
          <tr>
            ...
            <th style={{ width: 140 }}>Төрөл</th>
            <th style={{ width: 160 }}>Шинэчилсэн</th>
            <th style={{ width: 60 }}></th>
          </tr>
        </thead>
        <tbody>
          {SEGMENTS.map((s, i) => (
            <tr key={i} onClick={onOpenFilter} style={{ cursor: 'pointer' }}>
              ...
              <td><button className="btn btn-icon" onClick={(e)=>e.stopPropagation()}><Icon name="more" className="icon-sm" /></button></td>
            </tr>
          ))}
        </tbody>
      </table>
